  ...
  return (
    <main className="bg-white dark:bg-black flex min-h-screen flex-col items-center justify-between p-24">
      <div className="bg-white dark:bg-black z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <input
          className="bg-white dark:bg-black fixed left-4 right-4 top-4 w-auto w-[calc(100%-2rem)] justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:max-w-2xl lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30"
          type="text"
